import {
  ...
  const SwitchComponentFavorite = ({ setTypeProduct, setTypeSaleProduct }: TypeProps) => {
	...
	return (
	  <>
		...
		>
		  ...
		  <IOSSwitch
			defaultChecked={JSON.parse(typeSaleProduct) === "1" ? true : false}
  ...
  export default SwitchComponentFavorite;
