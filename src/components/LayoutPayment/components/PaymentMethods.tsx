import { FormControl, RadioGroup, Grid, Radio, Box, FormControlLabel } from '@mui/material'
import React, { Dispatch, SetStateAction, useEffect, useState } from 'react'
import { ColStyled, Text14ItalicStyled, Text18Styled, Title28Styled, WrapperBoxBorderStyled } from '../styled'
...
const PaymentMethods = ({ payMethod, setPayMethod }: Props) => {
  ...
  useEffect(() => {
    setColorActive(payMethod === 1 ? ['#FCB715', '#C7C9D9'] : ['#C7C9D9', '#FCB715'])
  }, [payMethod])
            ...
            <Grid item xs={12}>
              <BoxCheckStyled color={colorActive[1]}>
                <FormControlLabel
                  ...
                  label={
                    <ColStyled>
                      <Text18Styled style={{ marginBottom: 9 }}>Cổng thanh toán online</Text18Styled>
                      <Text14ItalicStyled>Sử dụng ATM đã đăng ký Internet Banking hoặc các thẻ Quốc tế Visa, Master card .....</Text14ItalicStyled>
                    </ColStyled>
                  }
                />
              </BoxCheckStyled>
