...
import { IconBath, IconBedDouble, IconCompass, IconFrame, IconPlusCircle } from '@components/Icons';
    ...
    <WrapperContent>
      ...
      <Grid>
        <ButtonStyled onClick={onClick}>
          <IconPlusCircle style={{ color: '#1b3459', width: 16, height: 16 }} />&nbsp;&nbsp;<TextStyled>So sánh</TextStyled>
        </ButtonStyled>
      </Grid>
    </WrapperContent>
  )
