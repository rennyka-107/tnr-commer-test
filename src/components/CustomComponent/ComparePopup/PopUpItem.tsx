...
const PopUpItem = ({data, onRemove}: PopUpItemProps) => {
  return <ItemWrapper>
    <Stack direction="column" spacing={1} justifyContent="space-between" style={{ height: '100%'}}>
      ...
      <Box style={{ position: "absolute", left: "165px", top: "0px", cursor: 'pointer' }}  onClick={onRemove}>
